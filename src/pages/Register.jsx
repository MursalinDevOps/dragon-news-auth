    ...
    return (
        ...
        <h2 className="text-3xl font-semibold text-center">Register your account</h2>
                ...
                <div className="form-control">
                        ...
                        <input type="text" placeholder="your name" className="input input-bordered rounded-none" required />
                    </div>
                    ...
                    <p className="text-center">Already Have An Account ? <Link className="text-green-800" to='/auth/register'>Login</Link> </p>
            </div>
        </div>
    );
};
